...
def assets():
	...
	with open('/home/osnapdev/uocis322/sql/osnap_legacy/HQ_inventory.csv', 'r') as csvfile, open('/home/osnapdev/uocis322/sql/osnap_legacy/NC_inventory.csv', 'r') as csv2, open('/home/osnapdev/uocis322/sql/osnap_legacy/SPNV_inventory.csv', 'r') as csv3, open('/home/osnapdev/uocis322/sql/osnap_legacy/DC_inventory.csv', 'r') as csv4, open('/home/osnapdev/uocis322/sql/osnap_legacy/MB005_inventory.csv', 'r') as csv5:
